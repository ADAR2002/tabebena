/*
  ...
  - You are about to drop the column `isActive` on the `DoctorSchedule` table. All the data in the column will be lost.
  - You are about to drop the column `slotDuration` on the `DoctorSchedule` table. All the data in the column will be lost.
